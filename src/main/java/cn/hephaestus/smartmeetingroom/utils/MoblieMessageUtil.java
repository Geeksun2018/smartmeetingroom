...
public class MoblieMessageUtil {
    ...
    //准备从配置文件中读取，暂未修改
    private static String accessKeyId = "LTAIlkbP6JvAz9i5";
    private static String accessKeySecret = "7GPsVnCy92y6Hz64WgMSwPtRFYXmLS";
    private static String signName = "行车付费宝";
    ...
    public static SendSmsResponse sendIdentifyingCode(String mobile, String code) throws ClientException{
        try {
            return sendSms(mobile, "{\"code\":\"" + code + "\"}", "SMS_151835106");
